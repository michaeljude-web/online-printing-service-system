    ...
    try:
        ...
        if mydb:
            ...
            if result:
                ...
                status = result[5] 
                if status == "Pending":
                    messagebox.showinfo("Account Pending", "Please wait for admin approval.")
...
def login_screen():
    ...
    Label(container, text="Login", font=("Arial", 18),
          bg="white", fg="black").pack(pady=(0, 80))

    Label(container, text="Email address:", font=("Arial", 10),
    ...
    login_btn = Button(container,
                       text="Login",
                       bg="#1E3A8A", fg="white",
                       font=("Arial", 10), relief="flat", height=2,
    ...
    label_text = Label(account_label_frame, text="Does not have account? ", 
                       fg="black", bg="white", font=("Arial", 9))
    label_text.pack(side="left")

    create_account_label = Label(account_label_frame, 
                                 text="Create here", 
                                 fg="#1E3A8A", 
                                 bg="white", 
                                 cursor="hand2", 
    ...
    create_account_label.bind("<Button-1>", lambda e: [window.destroy(), open_create_account()])
